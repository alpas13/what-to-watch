...
const PreviewFilm = React.memo(function PreviewFilm() {
  return (
      <Fragment>
        <article className="small-movie-card catalog__movies-card">
          ...
          <h3 className="small-movie-card__title">
            <a className="small-movie-card__link" href={`movie-page.html`}>Fantastic
        ...
        <article className="small-movie-card catalog__movies-card">
          ...
          <h3 className="small-movie-card__title">
            <a className="small-movie-card__link" href={`movie-page.html`}>Bohemian
              Rhapsody
            </a>
          </h3>
        </article>
        ...
        <article className="small-movie-card catalog__movies-card">
          ...
          <h3 className="small-movie-card__title">
            <a className="small-movie-card__link" href={`movie-page.html`}>We
              need
              to talk about Kevin
            </a>
          </h3>
        ...
        <article className="small-movie-card catalog__movies-card">
          ...
          <h3 className="small-movie-card__title">
            <a className="small-movie-card__link" href={`movie-page.html`}>What
              We
              Do in the Shadows
            </a>
          </h3>
        ...
        <article className="small-movie-card catalog__movies-card">
          ...
          <h3 className="small-movie-card__title">
            <a className="small-movie-card__link" href={`movie-page.html`}>Johnny
              English
            </a>
          </h3>
        </article>
        <article className="small-movie-card catalog__movies-card">
          ...
          <h3 className="small-movie-card__title">
            <a className="small-movie-card__link" href={`movie-page.html`}>Shutter
              Island
            </a>
          </h3>
        </article>
        <article className="small-movie-card catalog__movies-card">
          ...
          <h3 className="small-movie-card__title">
            <a className="small-movie-card__link" href={`movie-page.html`}>Pulp
              Fiction
            </a>
          </h3>
        </article>
        <article className="small-movie-card catalog__movies-card">
          ...
          <h3 className="small-movie-card__title">
            <a className="small-movie-card__link" href={`movie-page.html`}>No
              Country for Old Men
            </a>
          </h3>
        </article>
        ...
        <article className="small-movie-card catalog__movies-card">
          ...
          <h3 className="small-movie-card__title">
            <a className="small-movie-card__link" href={`movie-page.html`}>Moonrise
              Kingdom
            </a>
          </h3>
        </article>
        <article className="small-movie-card catalog__movies-card">
          ...
          <h3 className="small-movie-card__title">
            <a className="small-movie-card__link" href={`movie-page.html`}>Seven
              Years in Tibet
            </a>
          </h3>
        </article>
        <article className="small-movie-card catalog__movies-card">
          ...
          <h3 className="small-movie-card__title">
            <a className="small-movie-card__link" href={`movie-page.html`}>Midnight
              Special
            </a>
          </h3>
        </article>
        <article className="small-movie-card catalog__movies-card">
          ...
          <h3 className="small-movie-card__title">
            <a className="small-movie-card__link" href={`movie-page.html`}>War
              of
              the Worlds
            </a>
          </h3>
        ...
        <article className="small-movie-card catalog__movies-card">
          ...
          <h3 className="small-movie-card__title">
            <a className="small-movie-card__link" href={`movie-page.html`}>Dardjeeling
              Limited
            </a>
          </h3>
        </article>
